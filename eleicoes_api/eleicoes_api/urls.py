...
from urna.views import EleitorViewSet, EleicaoViewSet, CandidatoViewSet, AptidaoEleitorViewSet, VotoViewSet, verificar_comprovante, comprovante_qr
...
urlpatterns = [
    ...
    path('eleicoes_api/comprovantes/qr/', comprovante_qr),
]
